...
# Definizione della convoluzione depthwise separabile
...
class DDPM(nn.Module):
    def __init__(self, config):
        ...
        AttnBlock = functools.partial(LightweightAttnBlock)
        ...
        # Downsampling block
        modules.append(SeparableConv2d(channels, nf))
        hs_c = [nf]
        in_ch = nf
